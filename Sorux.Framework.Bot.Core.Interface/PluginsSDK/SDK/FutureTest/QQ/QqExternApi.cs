...
public static class QqExternApi
{
    ...
    public static Task<string> QqSendPrivateMessageAsync(this IBasicAPI basicApi,MessageContext context,string userId,string? groupId,string message,bool? autoEscape)
    {
    ...
    /// <param name="autoEscape">消息内容是否作为纯文本发送 ( 即不解析 CQ 码 ) , 只在 message 字段是字符串时有效</param>
    /// <returns>message_id:消息 ID</returns>
    public static Task<string> QqSendGroupMessageAsync(this IBasicAPI basicApi,MessageContext context,string? groupId,string message,bool? autoEscape)
    {
        Dictionary<string, string?> json = new Dictionary<string, string?>();
        json["group_id"] = groupId;
        json["message"] = message;
    ...
    /// <returns></returns>
    public static Task<string> QqSendGroupForwardAsync(this IBasicAPI basicApi,MessageContext context,string? group_id,string? messages)
    {
        Dictionary<string, string?> json = new Dictionary<string, string?>();
    ...
    /// <param name="messages">自定义转发消息</param>  
    /// <returns></returns>  
    public static string QqSendGroupForwardCompute(this IBasicAPI basicApi,MessageContext context,string? group_id,string? messages)  
    {  
        Dictionary<string, string?> json = new Dictionary<string, string?>();  
        json["group_id"] = group_id;  
        json["messages"] = messages;  
    ...
    /// <param name="autoEscape">消息内容是否作为纯文本发送 ( 即不解析 CQ 码 ) , 只在 message 字段是字符串时有效</param>  
    /// <returns>message_id:消息 ID</returns>
    public static void QqSendPrivateMessage(this IBasicAPI basicApi,MessageContext context,string userId,string? groupId,string message,bool? autoEscape)  
    {  
        Dictionary<string, string?> json = new Dictionary<string, string?>();  
        json["user_id"] = userId;  
        json["group_id"] = groupId;  
    ...
    /// <param name="autoEscape">消息内容是否作为纯文本发送 ( 即不解析 CQ 码 ) , 只在 message 字段是字符串时有效</param>  
    /// <returns>message_id:消息 ID</returns>
    public static void QqSendGroupMessage(this IBasicAPI basicApi,MessageContext context,string? groupId,string message,bool? autoEscape)  
    {  
        Dictionary<string, string?> json = new Dictionary<string, string?>();  
        json["group_id"] = groupId;  
        json["message"] = message;  
    ...
    /// <param name="messages">自定义转发消息</param>  
    /// <returns></returns>  
    public static void QqSendGroupForward(this IBasicAPI basicApi,MessageContext context,string? group_id,string? messages)  
    {  
        Dictionary<string, string?> json = new Dictionary<string, string?>();  
        json["group_id"] = group_id;  
        json["messages"] = messages;  
